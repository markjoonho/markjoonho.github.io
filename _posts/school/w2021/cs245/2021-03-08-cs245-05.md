...
<img src = "/assets/img/cs245/cs245.jpeg">
...
1. $$\phi$$ is a logical truth if for every structure for the language of $$\phi$$, and every assignmnet s that structure $$M(s) \vDash \phi$$.
...
2. $$\sum$$ logically implies $$\phi$$ if for every M, s, that make every member of $$\sum$$ get T, M(s) $$\vDash \phi$$.
